...
const messages = [
  "Gửi đến người con gái luôn mang đến niềm vui và hạnh phúc cho anh mỗi ngày.",
  "Anh luôn trân trọng và cảm thấy hạnh phúc vì có một người con gái quan tâm và hiểu mình như em",
  "Mỗi ngày được tâm sự được nghe em kể chuyện là anh thấy xua tan mọi mệt mỏi",
  "Chúc cô gái của anh ngày càng xinh đẹp, giỏi giang, đỗ nguyện vọng 1 nhoaaaaa, còn tiếp đóa ấn tiếp đi",
  "Tất cả những lời nói trên đều là tình cảm trân thành của anh, anh rất muốn được nói lời này nhưng mà anh nghĩ nên nói trực tiếp sẽ ý nghĩa hơn và hơn cả là anh muốn được nghe câu trả lời của em.",
];
      ...
      {showFinalEffect && (
        ...
        >
          ...
          >
            ...
            >
              Tối 8/3 mình đi chơi vs nhau nhé!
            </motion.div>
          </FinalMessage>
        </FullscreenOverlay>
      )}
